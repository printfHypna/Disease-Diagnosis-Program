...
public class LowerBack extends JFrame implements MouseListener{
	...
	JCheckBox chkIB = new JCheckBox("WEAKNESS IN LEG");

	JCheckBox chkITC= new JCheckBox("TINGLING IN LEG");

	JCheckBox chkBI = new JCheckBox("MUSCLE SPASM");
	
	JCheckBox chkCG = new JCheckBox("DECREASED FLEXIBILITY");
	JCheckBox chkCKS= new JCheckBox("DIFFICULTY WITH BALANCE");

	JCheckBox chkFP = new JCheckBox("LOWER BACK PAIN");
	
	JCheckBox chkLJ = new JCheckBox("DIFFICULTY WITH COORDINATION");
	public LowerBack() {
