...
public class UpperBack extends JFrame implements MouseListener {
	...
	JCheckBox chkIB = new JCheckBox("STIFFNESS IN UPPER BACK");

	JCheckBox chkITC= new JCheckBox("MUSCLE SPASMS");

	JCheckBox chkBI = new JCheckBox("NUMBNESS IN THE ABDOMEN");
